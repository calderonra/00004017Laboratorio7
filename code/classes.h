...
enum parameters {TAU, KAPPA, DELTA, LAMBDA , ETA, EXTERNAL_FORCE_X,EXTERNAL_FORCE_Y};
...
class mesh{
    ...
    public:
        void setParameters(float tau, float kappa, float delta, float lambda, float eta, float f_x, float f_y){
            parameters[TAU]=tau;
